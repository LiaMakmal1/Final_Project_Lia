...
/* release a matrix allocated by alloc_matrix */
...
/* parse one Python list row into a C double matrix row */
...
/* convert a Python list-of-lists to a C matrix */
...
/* build diagonal degree matrix from data X */
...
/* compute and return the diagonal degree matrix */
...
/* compute and return the normalized similarity matrix */
...
/* convert Python H and W to C matrices and validate dimensions */
...
/* run full symNMF optimization and return H */
